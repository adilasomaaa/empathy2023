...
class DashboardController extends Controller
{
    ...
    public function all_count()
    {
        ...
        $pesanan_status = [
            'dipesan' => Pemesanan::where('status', 'dipesan')->count(), 
            'dikonfirmasi_rs' => Pemesanan::where('status', 'dikonfirmasi_rs')->count(), 
            'dikonfirmasi_sopir' => Pemesanan::where('status', 'dikonfirmasi_sopir')->count(), 
