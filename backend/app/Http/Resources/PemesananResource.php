...
class PemesananResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'verifikasi_pemesanan' => $this->verifikasi_pemesanan ?? '-',
            'mobil' => $this->verifikasi_pemesanan ? $this->verifikasi_pemesanan->mobil :'-',
            'sopir' => $this->verifikasi_pemesanan ? $this->verifikasi_pemesanan->sopir :'-',
