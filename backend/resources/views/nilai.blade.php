            ...
            <div class="row">
                ...
                <table width="100%" style="border-collapse: collapse; border: 1px solid black; font-size: 10px" >
                    ...
                    <tr>
                        ...
                        <th style="border: 1px solid black" width="80%">Aspek Penilaian</th>
                        <th style="border: 1px solid black" width="15%">Nilai</th>
                    </tr>

                    @forelse ($seminar->registration->registration_period->grading_template->grading_list as $key => $list)
                        <tr>
                            <td style="border: 1px solid black" align="center" width="5%">{{ ++$key }}</td>
                            <td style="border: 1px solid black; padding : 10px" width="80%">{{ $list->aspect }}</td>
                            <td style="border: 1px solid black; padding : 10px" align="center" width="15%">{{ $penguji->grade->where('grading_list_id', $list->id)->first()->grade ?? '' }}</td>
                        </tr>
                    @empty
                ...
                <table width= "100%">
                    <tr>
                        ...
                        <td width="40%" align="right">
                            <img src="{{ $penguji->signature }}" width="300px" height="auto" style="border: 1px solid black" alt="">
                        </td>
                    </tr>
                </table>
            </div>
