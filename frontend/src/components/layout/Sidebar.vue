                                ...
                                <li class="nav-item">
                                    <router-link to="/master-rumahsakit" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Master Rumah Sakit</span>
                                        </div>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <router-link to="/master-pengguna" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Master Sopir</span>
                                        </div>
                                    </router-link>
                                </li>
                                <li class="nav-item">
