            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                <div class="flex justify-between items-center px-4 py-3">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        ...
                        <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">EMPATHY</span>
                    </router-link>
                    <a
                        href="javascript:;"
                ...
                >
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        ...
                        <li class="nav-item">
                            <ul>
                                <li class="nav-item">
                                    <router-link to="/master-rumahsakit" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <svg
                                                class="group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Master Rumah Sakit & Organisasi</span>
                                        </div>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/master-pengguna" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <svg
                                                class="group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Master Pengguna</span>
                                        </div>
                                    </router-link>
                                </li>
                            </ul>
                        ...
                        <h2 class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                            ...
                            <span>{{ $t('Menu Rumah Sakit') }}</span>
                        </h2>

                        <li class="nav-item">
                            <ul>
                                <li class="nav-item">
                                    <router-link to="/manajemen-pemesanan" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <svg
                                                class="group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Manajemen Pemesanan</span>
                                        </div>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/master-pengemudi" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <svg
                                                class="group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Master Pengemudi</span>
                                        </div>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/master-kenderaan" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <svg
                                                class="group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Master Kenderaan</span>
                                        </div>
                                    </router-link>
                                </li>
                            </ul>
                        ...
                        <h2 class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                            ...
                            <span>{{ $t('Menu Sopir') }}</span>
                        </h2>

                        <li class="nav-item">
                            <ul>
                                <li class="nav-item">
                                    <router-link to="/konfirmasi-pemesanan" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <svg
                                                class="group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Konfirmasi Pemesanan</span>
                                        </div>
                                    </router-link>
                                </li>
                                <!-- <li class="nav-item">
                                    <router-link to="/master-pengemudi" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Riwayat Pemesanan</span>
                                        </div>
                                    </router-link>
                                </li> -->
