<template>
    <div class="text-black dark:text-white-dark">
        ...
        <Header />
        <!--  END TOP NAVBAR  -->
        <section class="pb-24 flex items-center min-h-screen justify-center bg-white dark:bg-[#0e1726]">
            <div class="mx-auto max-w-[43rem]">
                <div class="text-center">
                <p class="text-lg font-medium leading-8 text-indigo-600/95 dark:text-white-light">EMPATHY</p>
                <h1 class="mt-3 text-[3.5rem] font-bold leading-[4rem] tracking-tight text-black dark:text-white-light">Emergency Pasient Information</h1>
                ...
                <a href="#pesan" class="transform rounded-md bg-indigo-600/95 px-5 py-3 font-medium text-white transition-colors hover:bg-indigo-700">Pesan Ambulance</a>
...
<script setup lang="ts">
    import Header from '@/components/layout/HeaderLanding.vue';
