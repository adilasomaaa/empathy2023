        ...
        <div class="panel sm:w-[480px] m-6 max-w-lg w-full">
            ...
            <form class="space-y-5" >
                <div>
                    ...
                    <input id="email" type="email" v-model="user.email" class="form-input" placeholder="Enter Email" />
                </div>
                <div>
        ...
        async login() {
            ...
            if(response){
                ...
                this.messages = {
                    show:true,
                    severity:'success',
                    content:'Login Berhasil, Anda akan dialihkan ke Halaman Dashboard.'
                }
                setTimeout(() => {
                    this.$router.replace({
                        name: 'dashboard'
                ...
                this.messages = {
                    show:true,
                    severity:'error',
                    content:'Login Gagal, Silahkan periksa kembali email dan password anda.'
                }
